...
<button className="primary-button px-5 py-2 rounded-md text-sm font-bold shadow-lg shadow-primary/20">Request Demo</button>
</div>
</div>
</header>
<main>
...
<div className="relative w-full max-w-lg aspect-[4/3] rounded-xl border border-outline-variant bg-surface-container overflow-hidden shadow-2xl shadow-primary/10" >
...
<div className="w-full bg-primary/20 h-[30%] rounded-t-sm border-t border-primary relative"><div className="absolute -top-1 right-0 w-2 h-2 bg-primary rounded-full"></div></div>
<div className="w-full bg-primary/20 h-[45%] rounded-t-sm border-t border-primary relative"><div className="absolute -top-1 right-0 w-2 h-2 bg-primary rounded-full"></div></div>
<div className="w-full bg-primary/20 h-[60%] rounded-t-sm border-t border-primary relative"><div className="absolute -top-1 right-0 w-2 h-2 bg-primary rounded-full"></div></div>
<div className="w-full bg-primary/20 h-[50%] rounded-t-sm border-t border-primary relative"><div className="absolute -top-1 right-0 w-2 h-2 bg-primary rounded-full"></div></div>
...
<div className="w-full bg-primary/20 h-[40%] rounded-t-sm border-t border-primary relative"><div className="absolute -top-1 right-0 w-2 h-2 bg-primary rounded-full"></div></div>
</div>
</div>
...
<div className="flex items-center gap-2"><span className="material-symbols-outlined text-3xl text-on-surface">token</span><span className="font-headline font-bold text-xl text-on-surface">Nexus Corp</span></div>
<div className="flex items-center gap-2"><span className="material-symbols-outlined text-3xl text-on-surface">all_inclusive</span><span className="font-headline font-bold text-xl text-on-surface">Aether Heavy</span></div>
<div className="flex items-center gap-2"><span className="material-symbols-outlined text-3xl text-on-surface">change_history</span><span className="font-headline font-bold text-xl text-on-surface">Tri-State</span></div>
<div className="flex items-center gap-2"><span className="material-symbols-outlined text-3xl text-on-surface">blur_on</span><span className="font-headline font-bold text-xl text-on-surface">Omni</span></div>
</div>
</div>
</section>
...
<div className="mb-16">
<h2 className="font-headline text-3xl md:text-4xl font-bold mb-4 text-on-surface">Industrial Intelligence. <br /><span className="text-secondary">Without the noise.</span></h2>
...
<span className="material-symbols-outlined text-secondary text-3xl">monitor_heart</span>
...
<span className="material-symbols-outlined text-secondary text-3xl mb-4">build_circle</span>
...
<div className="bento-card col-span-1 p-8 flex flex-col justify-between relative overflow-hidden group">
<div className="relative z-10 h-full flex flex-col">
<span className="material-symbols-outlined text-secondary text-3xl mb-4">psychology</span>
...
<span className="material-symbols-outlined text-secondary text-3xl mb-4">science</span>
...
<div className="w-full bg-surface h-2 rounded-full overflow-hidden border border-outline-variant/50"><div className="bg-primary w-[85%] h-full"></div></div>
</div>
<div>
...
<div className="w-full bg-surface h-2 rounded-full overflow-hidden border border-outline-variant/50"><div className="bg-primary w-[42%] h-full"></div></div>
</div>
</div>
</div>
</div>
...
<nav className="flex gap-6 text-sm text-on-surface-variant"><Link href="#" className="hover:text-primary transition-colors">About</Link><Link href="#" className="hover:text-primary transition-colors">Privacy</Link><Link href="#" className="hover:text-primary transition-colors">Terms</Link></nav>
