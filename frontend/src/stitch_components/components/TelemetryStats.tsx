    ...
    <div className="h-[40%] grid grid-cols-4 gap-panel-gap">
      <div className="glass-panel p-4 flex flex-col justify-between border-l-2 border-error/50">
        <div className="flex justify-between items-start">
          ...
          <span className="px-2 py-0.5 bg-error-container/20 text-error font-label-caps text-[9px] rounded-full pulse-red">
            CRITICAL
          </span>
        </div>
        <div className="flex items-baseline gap-2 mt-4">
          <span className="font-data-lg text-[28px] text-error font-bold leading-none">
            14.2
          </span>
      ...
      <div className="glass-panel p-4 flex flex-col justify-between border-l-2 border-secondary/50">
        <div className="flex justify-between items-start">
          ...
          <span className="px-2 py-0.5 bg-secondary-container/20 text-secondary font-label-caps text-[9px] rounded-full">
            WARNING
          </span>
        </div>
        <div className="flex items-baseline gap-2 mt-4">
          <span className="font-data-lg text-[28px] text-secondary font-bold leading-none">
            85.5
          </span>
          <span className="font-label-caps text-on-surface-variant text-[12px]">
            °C
      ...
      <div className="glass-panel p-4 flex flex-col justify-between border-l-2 border-emerald-500/50">
        <div className="flex justify-between items-start">
          ...
          <span className="px-2 py-0.5 bg-emerald-500/10 text-emerald-400 font-label-caps text-[9px] rounded-full">
            NORMAL
          </span>
        </div>
        <div className="flex items-baseline gap-2 mt-4">
          <span className="font-data-lg text-[28px] text-on-surface font-bold leading-none">
            42.1
          </span>
          <span className="font-label-caps text-on-surface-variant text-[12px]">
            A
      ...
      <div className="glass-panel p-4 flex flex-col justify-between border-l-2 border-emerald-500/50">
        ...
        <div className="flex items-baseline gap-2 mt-4">
          <span className="font-data-lg text-[28px] text-on-surface font-bold leading-none text-primary-fixed">
            110.5
          </span>
          <span className="font-label-caps text-on-surface-variant text-[12px]">
            L/MIN
