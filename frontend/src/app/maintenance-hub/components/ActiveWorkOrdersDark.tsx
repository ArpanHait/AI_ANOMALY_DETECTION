...
export default function ActiveWorkOrdersDark() {
  return (
    <div
    ...
    >
      <div className="p-4 border-b border-outline-variant/30 flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <span className="px-2 py-1 bg-surface-container text-on-surface-variant font-mono text-[12px] rounded text-xs border border-outline-variant/50">
            Filter: ALL
          </span>
        </div>
      </div>
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="font-mono text-[12px]">
            <tr className="hover:bg-surface-container/50 border-b border-outline-variant/10">
              ...
              <td className="p-3">
                <span className="text-[#64ffda]">In-Progress</span>
              </td>
            ...
            <tr className="hover:bg-surface-container/50 border-b border-outline-variant/10">
              ...
              <td className="p-3">
                <span className="text-secondary-container font-bold">WARNING</span>
              </td>
