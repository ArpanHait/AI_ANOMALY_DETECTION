...
export default function RcaNarrativeLight() {
  return (
    <div className="w-full md:w-auto md:flex-[30%] flex flex-col gap-1">
      ...
      >
        <div className="font-mono text-[11px] font-bold text-secondary mb-4 flex items-center space-x-2">
      ...
      >
        ...
        <div>
          <div className="flex justify-between font-mono text-xs text-on-error-container mb-1">
        ...
        <button className="mt-4 w-full bg-error text-on-error font-mono text-[11px] font-bold py-2 rounded hover:bg-on-error-container transition-colors">
          INITIATE WORK ORDER
        </button>
      </div>
      {/* Simulation Lab */}
